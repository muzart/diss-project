        ...
        foreach ($questions as $question):
            ...
            <div class="tab-pane fade <?= ($c == 1) ? "show active" : "" ?>" id="q<?= $c ?>" role="tabpanel"
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="question[<?= $c ?>]" id="q<?= $c ?>A" value="A">
                    <label class="form-check-label" for="q<?= $c ?>A">
                        <?=$question['a']?>
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="question[<?= $c ?>]" id="q<?= $c ?>B" value="B">
                    <label class="form-check-label" for="q<?= $c ?>B">
                        <?=$question['b']?>
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="question[<?= $c ?>]" id="q<?= $c ?>C" value="C">
                    <label class="form-check-label" for="q<?= $c ?>C">
                        <?=$question['c']?>
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="question[<?= $c ?>]" id="q<?= $c ?>D" value="D">
